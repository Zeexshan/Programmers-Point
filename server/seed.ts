  ...
  const technologiesData = [
    {
      name: "Python",
      category: "Backend",
      description: "Data science, automation, AI, scripting, backend",
      vacancies: 950,
      avgPackage: "3–5 LPA",
      topCompanies: "Google, Infosys, TCS",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "Java",
      category: "Backend",
      description: "Enterprise apps, backend, Android, web services",
      vacancies: 1200,
    ...
    },
    {
      name: "PHP",
      category: "Backend",
      description: "Web development, server scripting, CMS",
      vacancies: 600,
      avgPackage: "2.3–3 LPA",
      topCompanies: "Wipro, Capgemini, Infosys",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "JavaScript",
      category: "Frontend",
      description: "Frontend, UI, single-page apps",
      vacancies: 1100,
      avgPackage: "3–5 LPA",
      topCompanies: "Infosys, IBM, TCS",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "C",
      category: "Backend",
      description: "Embedded systems, OS, low-level programming",
      vacancies: 700,
      avgPackage: "2.2–3 LPA",
      topCompanies: "TCS, HCL, Wipro",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "C++",
      category: "Backend",
      description: "System software, game dev",
      vacancies: 650,
      avgPackage: "3–4.5 LPA",
      topCompanies: "Infosys, Tech Mahindra, TCS",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "ReactJS",
      category: "Frontend",
      description: "Modern web frontend, SPAs",
      vacancies: 850,
      avgPackage: "4–5.5 LPA",
      topCompanies: "Cognizant, Infosys, Wipro",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "Node.js",
      category: "Backend",
      description: "Backend, scalable web apps, real-time servers",
      vacancies: 800,
      avgPackage: "3.5–5 LPA",
      topCompanies: "Infosys, Capgemini, HCL",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "HTML/CSS",
      category: "Frontend",
      description: "Website structure & styling (frontend base)",
      vacancies: 900,
      avgPackage: "2–3 LPA",
      topCompanies: "Infosys, TCS, IBM",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "Bootstrap",
      category: "Frontend",
      description: "Rapid web UI prototyping",
      vacancies: 600,
      avgPackage: "2–3 LPA",
      topCompanies: "Infosys, IBM, startups",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "Django",
      category: "Backend",
      description: "Python-based web backend, APIs",
      vacancies: 400,
      avgPackage: "3.5–5 LPA",
      topCompanies: "Infosys, TCS, startups",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "Angular",
      category: "Frontend",
      description: "Large-scale enterprise frontends",
      vacancies: 350,
      avgPackage: "3.5–4.5 LPA",
      topCompanies: "Capgemini, Cognizant, TCS",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "Laravel",
      category: "Backend",
      description: "PHP-based web frameworks",
      vacancies: 250,
      avgPackage: "2.5–3.5 LPA",
      topCompanies: "Infosys, Capgemini, startups",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "Express.js",
      ...
      vacancies: 200,
      avgPackage: "3.5–4.5 LPA",
      topCompanies: "Infosys, service startups",
      lastUpdated: "29-Oct-2025",
    },
    {
      name: "Wordpress",
